...
const locales = {
  fr: {
    ...
    replacements: [
      ...
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and shaped by Japanese-inspired flavors.", "À quelques pas du bistro, Jan Fribus sert au P&ouml;lle 8 un menu pour les soirées particulières : calme, personnel et inspiré par les saveurs japonaises."],
  ...
  nl: {
    ...
    replacements: [
      ...
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and shaped by Japanese-inspired flavors.", "Op een paar stappen van de bistro serveert Jan Fribus aan de P&ouml;lle 8 een menu voor bijzondere avonden: rustig, persoonlijk en gevormd door Japans geïnspireerde smaken."],
  ...
  pl: {
    ...
    replacements: [
      ...
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and shaped by Japanese-inspired flavors.", "Kilka kroków od bistro, przy P&ouml;lle 8, Jan Fribus serwuje menu na wyjątkowe wieczory: spokojne, osobiste i inspirowane japońskimi smakami."],
  ...
  cs: {
    ...
    replacements: [
      ...
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and shaped by Japanese-inspired flavors.", "Jen pár kroků od bistra, na P&ouml;lle 8, podává Jan Fribus menu pro výjimečné večery: klidné, osobní a inspirované japonskými chutěmi."],
