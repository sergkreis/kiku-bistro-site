...
const locales = {
  fr: {
    ...
    replacements: [
      ...
      ["Evening atmosphere at KIKU", "Atmosphère du soir chez KIKU"],
      ["Special evenings at Restaurant KIKU.", "Des soirées spéciales au Restaurant KIKU."],
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and finished with fine Asian accents.", "À quelques pas du bistro, Jan Fribus sert au P&ouml;lle 8 un menu pour les soirées particulières : calme, personnel et avec de fins accents asiatiques."],
      ["Dinner menu", "Menu du soir"],
      ["Thursday to Sunday from 18:00", "Du jeudi au dimanche à partir de 18h00"],
      ["Reserve at the restaurant", "Réserver au restaurant"],
  ...
  nl: {
    ...
    replacements: [
      ...
      ["Evening atmosphere at KIKU", "Avondsfeer bij KIKU"],
      ["Special evenings at Restaurant KIKU.", "Bijzondere avonden bij Restaurant KIKU."],
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and finished with fine Asian accents.", "Op een paar stappen van de bistro serveert Jan Fribus aan de P&ouml;lle 8 een menu voor bijzondere avonden: rustig, persoonlijk en met fijne Aziatische accenten."],
      ["Dinner menu", "Avondmenu"],
      ["Thursday to Sunday from 18:00", "Donderdag tot en met zondag vanaf 18:00"],
      ["Reserve at the restaurant", "Boek bij het restaurant"],
  ...
  pl: {
    ...
    replacements: [
      ...
      ["Evening atmosphere at KIKU", "Wieczorna atmosfera w KIKU"],
      ["Special evenings at Restaurant KIKU.", "Wyjątkowe wieczory w Restaurant KIKU."],
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and finished with fine Asian accents.", "Kilka kroków od bistro, przy P&ouml;lle 8, Jan Fribus serwuje menu na wyjątkowe wieczory: spokojne, osobiste i z subtelnymi azjatyckimi akcentami."],
      ["Dinner menu", "Menu wieczorne"],
      ["Thursday to Sunday from 18:00", "Od czwartku do niedzieli od 18:00"],
      ["Reserve at the restaurant", "Zarezerwuj w restauracji"],
  ...
  cs: {
    ...
    replacements: [
      ...
      ["Evening atmosphere at KIKU", "Večerní atmosféra v KIKU"],
      ["Special evenings at Restaurant KIKU.", "Výjimečné večery v Restaurant KIKU."],
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and finished with fine Asian accents.", "Jen pár kroků od bistra, na P&ouml;lle 8, podává Jan Fribus menu pro výjimečné večery: klidné, osobní a s jemnými asijskými akcenty."],
      ["Dinner menu", "Večerní menu"],
      ["Thursday to Sunday from 18:00", "Od čtvrtka do neděle od 18:00"],
      ["Reserve at the restaurant", "Rezervovat v restauraci"],
...
const menuUpdateReplacements = {
  fr: [
    ...
    ["Homemade sourdough bread, black rye bread", "Pain au levain maison, pain de seigle noir"],
    ...
    ["Chicken, salad mix, parmesan", "Poulet, salade, parmesan"],
    ["Duck", "Canard"],
    ["Beetroot, jus", "Betterave, jus"],
    ["Orzo pasta", "Pâtes orzo"],
    ["Beef, mushrooms, parmesan, hoisin", "Bœuf, champignons, parmesan, hoisin"],
    ["Peppers, onions, egg", "Poivrons, oignons, œuf"],
    ["Mushrooms, parmesan", "Champignons, parmesan"],
    ["Pointed cabbage steak", "Steak de chou pointu"],
    ["Cauliflower pur&eacute;e, beurre blanc", "Purée de chou-fleur, beurre blanc"],
    ["Cheesecake", "Gâteau au fromage"],
    ["Vanilla cream, caramel, apple compote", "Crème vanille, caramel, compote de pommes"],
  ...
  nl: [
    ...
    ["Homemade sourdough bread, black rye bread", "Huisgemaakt zuurdesembrood, zwart roggebrood"],
    ...
    ["Chicken, salad mix, parmesan", "Kip, slamix, parmezaan"],
    ["Duck", "Eend"],
    ["Beetroot, jus", "Rode biet, jus"],
    ["Orzo pasta", "Orzo-pasta"],
    ["Beef, mushrooms, parmesan, hoisin", "Rundvlees, paddenstoelen, parmezaan, hoisin"],
    ["Peppers, onions, egg", "Paprika, uien, ei"],
    ["Mushrooms, parmesan", "Paddenstoelen, parmezaan"],
    ["Pointed cabbage steak", "Spitskoolsteak"],
    ["Cauliflower pur&eacute;e, beurre blanc", "Bloemkoolpuree, beurre blanc"],
    ["Cheesecake", "Cheesecake"],
    ["Vanilla cream, caramel, apple compote", "Vanillecrème, karamel, appelcompote"],
  ...
  pl: [
    ...
    ["Homemade sourdough bread, black rye bread", "Domowy chleb na zakwasie, czarny chleb żytni"],
    ...
    ["Chicken, salad mix, parmesan", "Kurczak, mix sałat, parmezan"],
    ["Duck", "Kaczka"],
    ["Beetroot, jus", "Burak, jus"],
    ["Orzo pasta", "Makaron orzo"],
    ["Beef, mushrooms, parmesan, hoisin", "Wołowina, grzyby, parmezan, hoisin"],
    ["Peppers, onions, egg", "Papryka, cebula, jajko"],
    ["Mushrooms, parmesan", "Grzyby, parmezan"],
    ["Pointed cabbage steak", "Stek z kapusty stożkowej"],
    ["Cauliflower pur&eacute;e, beurre blanc", "Purée z kalafiora, beurre blanc"],
    ["Cheesecake", "Sernik"],
    ["Vanilla cream, caramel, apple compote", "Krem waniliowy, karmel, mus jabłkowy"],
  ...
  cs: [
    ...
    ["Homemade sourdough bread, black rye bread", "Domácí kváskový chléb, černý žitný chléb"],
    ...
    ["Chicken, salad mix, parmesan", "Kuře, salátový mix, parmazán"],
    ["Duck", "Kachna"],
    ["Beetroot, jus", "Červená řepa, jus"],
    ["Orzo pasta", "Těstoviny orzo"],
    ["Beef, mushrooms, parmesan, hoisin", "Hovězí maso, houby, parmazán, hoisin"],
    ["Peppers, onions, egg", "Paprika, cibule, vejce"],
    ["Mushrooms, parmesan", "Houby, parmazán"],
    ["Pointed cabbage steak", "Steak ze špičatého zelí"],
    ["Cauliflower pur&eacute;e, beurre blanc", "Květákové pyré, beurre blanc"],
    ["Cheesecake", "Tvarohový koláč"],
    ["Vanilla cream, caramel, apple compote", "Vanilkový krém, karamel, jablečný kompot"],
