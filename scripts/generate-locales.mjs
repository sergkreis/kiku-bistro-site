...
const menuUpdateReplacements = {
  fr: [
    ...
    ["Salmon, prawns, fennel, cream", "Saumon, crevettes, fenouil, crème"],
    ...
    ["Sweet croissant", "Croissant sucré"],
    ["Mascarpone, berries, caramel", "Mascarpone, baies, caramel"],
    ["Layer cake", "Gâteau en couches"],
  ...
  nl: [
    ...
    ["Burrata salad", "Burratasalade"],
    ["Caesar salad", "Caesarsalade"],
    ["Salad mix, chicken, parmesan", "Slamix, kip, parmezaan"],
    ["Fish soup", "Vissoep"],
    ["Salmon, prawns, fennel, cream", "Zalm, garnalen, venkel, room"],
    ...
    ["Sweet croissant", "Zoete croissant"],
    ["Mascarpone, berries, caramel", "Mascarpone, bessen, karamel"],
    ["Layer cake", "Laagjescake"],
  ...
  pl: [
    ...
    ["Sweet croissant", "Słodki croissant"],
    ["Mascarpone, berries, caramel", "Mascarpone, owoce jagodowe, karmel"],
  ...
  cs: [
    ...
    ["Sweet croissant", "Sladký croissant"],
    ["Mascarpone, berries, caramel", "Mascarpone, bobulové ovoce, karamel"],
    ["Layer cake", "Vrstvený dort"],
    ["Honey cream, passion fruit, ice cream", "Medový krém, mučenka, zmrzlina"],
  ],
};
