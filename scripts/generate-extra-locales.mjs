...
const locales = {
  it: {
    ...
    replacements: [
      ...
      ["Buratta salad", "Insalata di burrata"],
      ["Tomatoes, salad mix, pesto", "Pomodori, misticanza, pesto"],
      ...
      ["Tiramisu with ice cream", "Tiramisu con gelato"],
      ...
      ["Evening atmosphere at KIKU", "Atmosfera serale da KIKU"],
      ["Special evenings at Restaurant KIKU.", "Serate speciali al Restaurant KIKU."],
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and finished with fine Asian accents.", "A pochi passi dal bistrot, Jan Fribus serve al P&ouml;lle 8 un menu per serate speciali: tranquillo, personale e con delicati accenti asiatici."],
      ["Dinner menu", "Menu serale"],
      ["Thursday to Sunday from 18:00", "Da giovedì a domenica dalle 18:00"],
      ["Reserve at the restaurant", "Prenota al ristorante"],
  ...
  es: {
    ...
    replacements: [
      ...
      ["Buratta salad", "Ensalada de burrata"],
      ["Tomatoes, salad mix, pesto", "Tomates, mezclum, pesto"],
      ["Stracciatella, pesto", "Stracciatella, pesto"],
      ["Gnocchi with gorgonzola", "Gnocchi con gorgonzola"],
      ...
      ["Tiramisu with ice cream", "Tiramis&uacute; con helado"],
      ...
      ["Yuzu mascarpone, chocolate-hazelnut praline, caramel", "Mascarpone de yuzu, pralin&eacute; de chocolate y avellana, caramelo"],
      ["Honey cake with ice cream", "Bizcocho de miel con helado"],
      ...
      ["Evening atmosphere at KIKU", "Ambiente de noche en KIKU"],
      ["Special evenings at Restaurant KIKU.", "Noches especiales en Restaurant KIKU."],
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and finished with fine Asian accents.", "A pocos pasos del bistró, Jan Fribus sirve en P&ouml;lle 8 un menú para noches especiales: tranquilo, personal y con finos acentos asiáticos."],
      ["Dinner menu", "Menú de cena"],
      ["Thursday to Sunday from 18:00", "De jueves a domingo desde las 18:00"],
      ["Reserve at the restaurant", "Reservar en el restaurante"],
  ...
  pt: {
    ...
    replacements: [
      ...
      ["Buratta salad", "Salada de burrata"],
      ["Tomatoes, salad mix, pesto", "Tomates, mix de salada, pesto"],
      ["Stracciatella, pesto", "Stracciatella, pesto"],
      ...
      ["Tiramisu with ice cream", "Tiramisu com gelado"],
      ...
      ["Yuzu mascarpone, chocolate-hazelnut praline, caramel", "Mascarpone de yuzu, pralin&eacute; de chocolate e avel&atilde;, caramelo"],
      ["Honey cake with ice cream", "Bolo de mel com gelado"],
      ...
      ["Evening atmosphere at KIKU", "Ambiente de noite no KIKU"],
      ["Special evenings at Restaurant KIKU.", "Noites especiais no Restaurant KIKU."],
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and finished with fine Asian accents.", "A poucos passos do bistro, Jan Fribus serve no P&ouml;lle 8 um menu para noites especiais: tranquilo, pessoal e com delicados acentos asiáticos."],
      ["Dinner menu", "Menu de jantar"],
      ["Thursday to Sunday from 18:00", "De quinta a domingo a partir das 18:00"],
      ["Reserve at the restaurant", "Reservar no restaurante"],
  ...
  ja: {
    ...
    replacements: [
      ...
      ["Tomato salad", "トマトサラダ"],
      ["Buratta salad", "&#12502;&#12483;&#12521;&#12540;&#12479;&#12469;&#12521;&#12480;"],
      ["Tomatoes, salad mix, pesto", "&#12488;&#12510;&#12488;&#12289;&#12469;&#12521;&#12480;&#12511;&#12483;&#12463;&#12473;&#12289;&#12506;&#12473;&#12488;"],
      ...
      ["Tiramisu with ice cream", "&#12486;&#12451;&#12521;&#12511;&#12473;&#12392;&#12450;&#12452;&#12473;"],
      ...
      ["Yuzu mascarpone, chocolate-hazelnut praline, caramel", "柚子マスカルポーネ、チョコレートヘーゼルナッツプラリネ、キャラメル"],
      ["Honey cake with ice cream", "ハニーケーキ アイス添え"],
      ...
      ["Evening atmosphere at KIKU", "KIKUの夜の雰囲気"],
      ["Special evenings at Restaurant KIKU.", "Restaurant KIKUで特別な夜を。"],
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and finished with fine Asian accents.", "ビストロから歩いてすぐのP&ouml;lle 8で、Jan Fribusが特別な夜のためのメニューをご用意します。静かでパーソナル、繊細なアジアのアクセントを添えた料理です。"],
      ["Dinner menu", "ディナーメニュー"],
      ["Thursday to Sunday from 18:00", "木曜日から日曜日 18:00より"],
      ["Reserve at the restaurant", "レストランを予約する"],
...
const menuUpdateReplacements = {
  it: [
    ...
    ["Tomato and burrata open sandwich", "Tartina con pomodoro e burrata"],
    ["Brioche, avocado, pesto", "Brioche, avocado, pesto"],
    ["Vanilla cream and apple", "Crema alla vaniglia e mela"],
    ["Homemade sourdough bread, black rye bread", "Pane a lievitazione naturale fatto in casa, pane di segale nero"],
    ["Bread basket with butter &amp; dips", "Cestino di pane con burro &amp; dip"],
    ["Hummus with sourdough bread", "Hummus con pane a lievitazione naturale"],
    ["Brioche, mushrooms, salad mix", "Brioche, funghi, misticanza"],
    ["Burrata salad", "Insalata di burrata"],
    ["Caesar salad", "Insalata Caesar"],
    ["Chicken, salad mix, parmesan", "Pollo, misticanza, parmigiano"],
    ["Duck", "Anatra"],
    ["Beetroot, jus", "Barbabietola, jus"],
    ["Orzo pasta", "Pasta orzo"],
    ["Beef, mushrooms, parmesan, hoisin", "Manzo, funghi, parmigiano, hoisin"],
    ["Peppers, onions, egg", "Peperoni, cipolle, uovo"],
    ["Mushrooms, parmesan", "Funghi, parmigiano"],
    ["Pointed cabbage steak", "Bistecca di cavolo a punta"],
    ["Cauliflower pur&eacute;e, beurre blanc", "Purea di cavolfiore, beurre blanc"],
    ["Cheesecake", "Cheesecake"],
    ["Vanilla cream, caramel, apple compote", "Crema alla vaniglia, caramello, composta di mele"],
    ["Salad mix, chicken, parmesan", "Misticanza, pollo, parmigiano"],
    ["Fish soup", "Zuppa di pesce"],
    ["Salmon, prawns, fennel, cream", "Salmone, gamberi, finocchio, panna"],
    ["Gorgonzola, prawns, bisque", "Gorgonzola, gamberi, bisque"],
    ["Beef ragout", "Ragù di manzo"],
    ["Parsley potatoes, lingonberries, salad", "Patate al prezzemolo, mirtilli rossi, insalata"],
    ["Singapore chili chicken", "Pollo chili Singapore"],
    ["Truffle risotto", "Risotto al tartufo"],
    ["Truffle, parmesan", "Tartufo, parmigiano"],
    ["Vanilla cream, apple", "Crema alla vaniglia, mela"],
    ["Mascarpone, coffee, vanilla ice cream", "Mascarpone, caffè, gelato alla vaniglia"],
    ["Sweet croissant", "Croissant dolce"],
    ["Mascarpone, berries, caramel", "Mascarpone, frutti di bosco, caramello"],
  ...
  es: [
    ...
    ["Tomato and burrata open sandwich", "Tosta de tomate y burrata"],
    ["Brioche, avocado, pesto", "Brioche, aguacate, pesto"],
    ["Vanilla cream and apple", "Crema de vainilla y manzana"],
    ["Homemade sourdough bread, black rye bread", "Pan de masa madre casero, pan de centeno negro"],
    ["Bread basket with butter &amp; dips", "Cesta de pan con mantequilla y dips"],
    ["Hummus with sourdough bread", "Hummus con pan de masa madre"],
    ["Brioche, mushrooms, salad mix", "Brioche, setas, mezclum"],
    ["Burrata salad", "Ensalada de burrata"],
    ["Caesar salad", "Ensalada César"],
    ["Chicken, salad mix, parmesan", "Pollo, mezclum, parmesano"],
    ["Duck", "Pato"],
    ["Beetroot, jus", "Remolacha, jus"],
    ["Orzo pasta", "Pasta orzo"],
    ["Beef, mushrooms, parmesan, hoisin", "Ternera, setas, parmesano, hoisin"],
    ["Peppers, onions, egg", "Pimientos, cebolla, huevo"],
    ["Mushrooms, parmesan", "Setas, parmesano"],
    ["Pointed cabbage steak", "Filete de col picuda"],
    ["Cauliflower pur&eacute;e, beurre blanc", "Puré de coliflor, beurre blanc"],
    ["Cheesecake", "Tarta de queso"],
    ["Vanilla cream, caramel, apple compote", "Crema de vainilla, caramelo, compota de manzana"],
    ["Salad mix, chicken, parmesan", "Mezclum, pollo, parmesano"],
    ["Fish soup", "Sopa de pescado"],
    ["Salmon, prawns, fennel, cream", "Salmón, gambas, hinojo, nata"],
    ["Gorgonzola, prawns, bisque", "Gorgonzola, gambas, bisque"],
    ["Beef ragout", "Ragú de ternera"],
    ["Parsley potatoes, lingonberries, salad", "Patatas al perejil, arándanos rojos, ensalada"],
    ["Singapore chili chicken", "Pollo chili Singapore"],
    ["Truffle risotto", "Risotto de trufa"],
    ["Truffle, parmesan", "Trufa, parmesano"],
    ["Vanilla cream, apple", "Crema de vainilla, manzana"],
    ["Mascarpone, coffee, vanilla ice cream", "Mascarpone, café, helado de vainilla"],
    ["Sweet croissant", "Croissant dulce"],
    ["Mascarpone, berries, caramel", "Mascarpone, frutos rojos, caramelo"],
    ["Layer cake", "Tarta de capas"],
  ...
  pt: [
    ...
    ["Tomato and burrata open sandwich", "Sanduíche aberta de tomate e burrata"],
    ["Brioche, avocado, pesto", "Brioche, abacate, pesto"],
    ["Vanilla cream and apple", "Creme de baunilha e maçã"],
    ["Homemade sourdough bread, black rye bread", "Pão de massa-mãe caseiro, pão de centeio escuro"],
    ["Bread basket with butter &amp; dips", "Cesto de pão com manteiga e dips"],
    ["Hummus with sourdough bread", "Húmus com pão de massa-mãe"],
    ["Brioche, mushrooms, salad mix", "Brioche, cogumelos, mistura de saladas"],
    ["Burrata salad", "Salada de burrata"],
    ["Caesar salad", "Salada César"],
    ["Chicken, salad mix, parmesan", "Frango, mistura de saladas, parmesão"],
    ["Duck", "Pato"],
    ["Beetroot, jus", "Beterraba, jus"],
    ["Orzo pasta", "Massa orzo"],
    ["Beef, mushrooms, parmesan, hoisin", "Carne de vaca, cogumelos, parmesão, hoisin"],
    ["Peppers, onions, egg", "Pimentos, cebola, ovo"],
    ["Mushrooms, parmesan", "Cogumelos, parmesão"],
    ["Pointed cabbage steak", "Bife de couve pontiaguda"],
    ["Cauliflower pur&eacute;e, beurre blanc", "Puré de couve-flor, beurre blanc"],
    ["Cheesecake", "Tarte de queijo"],
    ["Vanilla cream, caramel, apple compote", "Creme de baunilha, caramelo, compota de maçã"],
    ["Salad mix, chicken, parmesan", "Mistura de saladas, frango, parmesão"],
    ["Fish soup", "Sopa de peixe"],
    ["Salmon, prawns, fennel, cream", "Salmão, camarões, funcho, natas"],
    ["Gorgonzola, prawns, bisque", "Gorgonzola, camarões, bisque"],
    ["Beef ragout", "Ragout de vaca"],
    ["Parsley potatoes, lingonberries, salad", "Batatas com salsa, airelas, salada"],
    ["Singapore chili chicken", "Frango chili Singapore"],
    ["Truffle risotto", "Risotto de trufa"],
    ["Truffle, parmesan", "Trufa, parmesão"],
    ["Vanilla cream, apple", "Creme de baunilha, maçã"],
    ["Mascarpone, coffee, vanilla ice cream", "Mascarpone, café, gelado de baunilha"],
    ["Sweet croissant", "Croissant doce"],
    ["Mascarpone, berries, caramel", "Mascarpone, frutos vermelhos, caramelo"],
  ...
  ja: [
    ...
    ["Tomato and burrata open sandwich", "トマトとブッラータのオープンサンド"],
    ["Brioche, avocado, pesto", "ブリオッシュ、アボカド、ペスト"],
    ["Vanilla cream and apple", "バニラクリームとリンゴ"],
    ["Homemade sourdough bread, black rye bread", "自家製サワードウブレッド、黒ライ麦パン"],
    ["Bread basket with butter &amp; dips", "バターとディップ付きパンバスケット"],
    ["Hummus with sourdough bread", "フムスとサワードウブレッド"],
    ["Brioche, mushrooms, salad mix", "ブリオッシュ、キノコ、サラダミックス"],
    ["Burrata salad", "ブッラータサラダ"],
    ["Caesar salad", "シーザーサラダ"],
    ["Chicken, salad mix, parmesan", "チキン、サラダミックス、パルメザン"],
    ["Duck", "鴨肉"],
    ["Beetroot, jus", "ビーツ、ジュ"],
    ["Orzo pasta", "オルゾパスタ"],
    ["Beef, mushrooms, parmesan, hoisin", "牛肉、キノコ、パルメザン、海鮮醤"],
    ["Peppers, onions, egg", "パプリカ、玉ねぎ、卵"],
    ["Mushrooms, parmesan", "キノコ、パルメザン"],
    ["Pointed cabbage steak", "尖りキャベツのステーキ"],
    ["Cauliflower pur&eacute;e, beurre blanc", "カリフラワーピューレ、ブールブラン"],
    ["Cheesecake", "チーズケーキ"],
    ["Vanilla cream, caramel, apple compote", "バニラクリーム、キャラメル、リンゴのコンポート"],
    ["Salad mix, chicken, parmesan", "サラダミックス、チキン、パルメザン"],
    ["Fish soup", "魚介スープ"],
    ["Salmon, prawns, fennel, cream", "サーモン、海老、フェンネル、クリーム"],
    ["Gorgonzola, prawns, bisque", "ゴルゴンゾーラ、海老、ビスク"],
    ["Beef ragout", "牛肉のラグー"],
    ["Parsley potatoes, lingonberries, salad", "パセリポテト、リンゴンベリー、サラダ"],
    ["Singapore chili chicken", "シンガポールチリチキン"],
    ["Truffle risotto", "トリュフリゾット"],
    ["Truffle, parmesan", "トリュフ、パルメザン"],
    ["Vanilla cream, apple", "バニラクリーム、リンゴ"],
    ["Mascarpone, coffee, vanilla ice cream", "マスカルポーネ、コーヒー、バニラアイス"],
    ["Sweet croissant", "スイートクロワッサン"],
    ["Mascarpone, berries, caramel", "マスカルポーネ、ベリー、キャラメル"],
    ["Layer cake", "レイヤーケーキ"],
    ["Honey cream, passion fruit, ice cream", "ハニークリーム、パッションフルーツ、アイス"],
  ],
};
...
<html lang="${code}">
  <head>
    ...
    <link rel="stylesheet" href="../styles.css?v=20260621-design-review-1" />
  </head>
