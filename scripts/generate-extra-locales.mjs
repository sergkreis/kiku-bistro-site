...
const menuUpdateReplacements = {
  it: [
    ...
    ["Passion fruit, mango ice cream", "Frutto della passione, gelato al mango"],
  ],
  es: [
    ...
    ["Passion fruit, mango ice cream", "Fruta de la pasión, helado de mango"],
  ],
  pt: [
    ...
    ["Passion fruit, mango ice cream", "Maracujá, gelado de manga"],
  ],
  ja: [
    ...
    ["Honey cake", "ハニーケーキ"],
    ["Passion fruit, mango ice cream", "パッションフルーツ、マンゴーアイス"],
  ],
};
