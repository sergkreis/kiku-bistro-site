...
const locales = {
  it: {
    ...
    replacements: [
      ...
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and shaped by Japanese-inspired flavors.", "A pochi passi dal bistrot, Jan Fribus serve al P&ouml;lle 8 un menu per serate speciali: tranquillo, personale e ispirato ai sapori giapponesi."],
  ...
  es: {
    ...
    replacements: [
      ...
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and shaped by Japanese-inspired flavors.", "A pocos pasos del bistró, Jan Fribus sirve en P&ouml;lle 8 un menú para noches especiales: tranquilo, personal y marcado por sabores de inspiración japonesa."],
  ...
  pt: {
    ...
    replacements: [
      ...
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and shaped by Japanese-inspired flavors.", "A poucos passos do bistro, Jan Fribus serve no P&ouml;lle 8 um menu para noites especiais: tranquilo, pessoal e marcado por sabores de inspiração japonesa."],
  ...
  ja: {
    ...
    replacements: [
      ...
      ["Just a few steps from the bistro, Jan Fribus serves a menu for special evenings at P&ouml;lle 8: calm, personal and shaped by Japanese-inspired flavors.", "ビストロから歩いてすぐのP&ouml;lle 8で、Jan Fribusが特別な夜のためのメニューをご用意します。静かでパーソナル、日本の味わいに着想を得た料理です。"],
